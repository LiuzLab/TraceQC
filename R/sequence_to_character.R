...
#'
#' @examples
seq_to_character <- function(aligned_reads,out_file) {
  ...
  mutation_df <- mapply(find_position,all_insertions,all_deletions,all_mutations,
                        target_seqs,read_counts,SIMPLIFY=FALSE) %>%
    bind_rows()
